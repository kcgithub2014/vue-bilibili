<template>
  <div class="channel">
    ...
    <div class="mad" ref="mad">
      <scroll class="mad-content" ref="scroll" @scroll="scroll" :data="list" :pullup="pullup" :listenScroll="listenScroll" :probeType="probeType" @scrollEnd="scrollEnd">
        <div>
          <list :list="list"></list>
